...
const Header: React.FC = () => {
    ...
    return (
        <Container>
            ...
            <a href="https://www.instagram.com/iaghocristian/" data-tip="Visitar Instagram">
                <img src={instagramImg} alt="Instagram icon"/>
            </a>
            <a href="https://www.facebook.com/iagho.cristian" data-tip="Visitar Facebook">
            ...
            <a href="https://www.linkedin.com/in/iagho-cristian/" data-tip="Visitar LinkedIn">
                <img src={linkedinImg} alt="LinkedIn icon"/>
            </a>
            <a href="https://github.com/iaghoCristian" data-tip="Visitar GitHub">
